...
class SMTPConnection:
    ...
    def __ehlo(self):
        try:
            ...
            logger.error('The server did not reply properly to the EHLO/HELO.')
            exit(1)
    ...
    def __connect(self):
        try:
            ...
            logger.error('Sorry unable to connect to smtplib socket..')
            exit(1)
    ...
    def __eval_server_features(self):
        ...
        if not supported_auth_features:
            logger.error('SMTP server does not support AUTH LOGIN.')
            exit(1)
    ...
    def login(self, username, password):
        try:
            ...
            logger.error('The Username and Password you entered is wrong.')
            return False
    ...
    def send_mail(self, message):
        try:
            ...
            logger.success('Message Sucessfully Sent!')
        except smtplib.SMTPException:
